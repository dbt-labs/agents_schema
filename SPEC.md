...
The Power BI connector ingests local JSON/YAML exports from Microsoft Fabric /
Power BI scanner output. It preserves source-native identifiers and common
agent-useful context such as names, descriptions, fields, measures, reports,
