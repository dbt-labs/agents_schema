...
This document describes the warehouse tables produced by this repository's current ingestion workflows. The SQL below is written in Snowflake form; Databricks writes the same logical tables with equivalent Databricks types.
