...
This document describes the warehouse tables produced by this repository's current ingestion workflows. The SQL below is written in Snowflake form; supported destinations write the same logical tables with destination-specific equivalent types.
