...
ROOT_ENTRIES = {
    "core": (
        ...
        ("schemata", "Information-schema-like schema context view: information_schema.schemata enriched from provider *_SCHEMATA views. See AGENTS.SCHEMATA."),
    ...
    "dbt": (
        ...
        ("schemata", "Provider-normalized schema context view. See AGENTS.DBT_SCHEMATA."),
    ...
    "lookml": (
        ...
        ("schemata", "Provider-normalized schema context view. See AGENTS.LOOKML_SCHEMATA."),
    ...
    "osi": (
        ...
        ("schemata", "Provider-normalized schema context view. See AGENTS.OSI_SCHEMATA."),
